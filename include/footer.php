...
<footer class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-gray-400">
                    Your trusted mobile phone shop with the latest smartphones and
                    accessories.
                </p>
            </div>
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li>
                        <a href="#" class="hover:text-white transition-colors">Smartphones</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-white transition-colors">Accessories</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-white transition-colors">Cases & Covers</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-white transition-colors">Chargers</a>
                    </li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 TecHub Mobile Phone Shop. All rights reserved.</p>
        </div>
    </div>
</footer>
...
<div class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
    <div class="flex justify-around py-2">
        <a href="#phones" class="flex flex-col items-center p-2 text-gray-600 hover:text-blue-600">
            <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                <path
                    d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
            </svg>
            <span class="text-xs">Phones</span>
        </a>
        <a href="#accessories" class="flex flex-col items-center p-2 text-gray-600 hover:text-blue-600">
            <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                <path
        ...
        <a href="../pages/contact.php" class="flex flex-col items-center p-2 text-gray-600 hover:text-blue-600">
            <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                <path
